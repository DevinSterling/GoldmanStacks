	...
	<body>
    	...
    	<div class="container flex-center">
            <div class="list mini">
                ...
                <a href="transactions?id=<? echo $user ?>" class="tab-button transform-button round selected"  data-id="change-password" data-title="Change Password">
                    <div class="split">
                        <div class="text-right">
                            <p>Transactions</p>
                        </div>
                ...
                <a href="payments?id=<? echo $user ?>" class="tab-button transform-button round"  data-id="change-password" data-title="Change Password">
                    <div class="split">
                        <div class="text-right">
                            <p>Payments</p>
                        </div>
