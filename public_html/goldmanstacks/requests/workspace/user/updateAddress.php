...
if (hash_equals($calc, $token)
    && checkNotEmpty($userID, $addressLine1, $addressCity, $addressState, $addressPostalCode)) { // if true, non-empty parameters given
    ...
    if ($isMatch) {
        ...
        if ($db !== null) {
            ...
            $stmt->close();
            $db->close();
        } else $dbMessage = 'test3!';
    } else $dbMessage = 'test2!';
} else $dbMessage = 'test1!';
